...
namespace FinancialChat.UI.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(FinancialChatContext context)
        {
            _context = context;
        }
        ...
        {
            var financialChatContext = _context.Users;
            return View(await financialChatContext.ToListAsync());
        }
        ...
        {
            ViewData["Id"] = new SelectList(_context.Messages, "Id", "Text");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Email")] User user)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Messages, "Id", "Text", user.Id);
            return View(user);
        }
